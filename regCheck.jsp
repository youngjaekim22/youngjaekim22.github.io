  ...
  <body>
    <section>
      ...
      <section>
        ...
        <h2>성별/취미</h2>
        <h2>아이디:<%=request.getParameter("stud_gender")%>, 취미:<% String[] uHobby=request.getParameter("stud_hobby");%><% if(uHobby==null){out.println("입력내용없음");}else{for(int i=0;i<uHobby.length; i++){out.println(uHobby[i]);}}%><br/></h2>    
      </section>
    </section>
  </body>
</html>
